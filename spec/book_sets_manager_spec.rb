...
describe BookSetsManager do
  ...
  describe ".balanced_sets" do
    it "when a pretty homogeneous list of books is given" do
      ...
      book_sets_manager.unbalanced_sets
      book_sets_manager.balanced_sets.should == result
    end
